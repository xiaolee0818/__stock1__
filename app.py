...
def index():
    ...
    if request.method=='POST':
        ...
        stock_datFrame=datasource.get_stock_data(stockid=stock_id,year=year)
        stock_data=stock_datFrame.to_numpy().tolist()
        
        fig=px.line(stock_datFrame,x='Date',y='Adj Close',title=f'{stock_name}_{year}')
